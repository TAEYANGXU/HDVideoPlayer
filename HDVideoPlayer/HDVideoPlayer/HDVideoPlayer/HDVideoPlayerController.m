...
@end
@implementation HDVideoPlayerController
...
- (void)playButtonClick
{
    ...
    self.videoControl.playButton.hidden = YES;
    self.videoControl.pauseButton.hidden = NO;
    self.videoControl.isPauseing = NO;
    self.movieBackgroundView.hidden = YES;
}
...
- (void)pauseButtonClick
{
    ...
    self.videoControl.playButton.hidden = NO;
    self.videoControl.pauseButton.hidden = YES;
    self.videoControl.isPauseing = YES;
}
...
- (HDVideoPlayerView *)videoControl
{
    if (!_videoControl) {
        _videoControl = [[HDVideoPlayerView alloc] init];
    }
